...
#define FILENAME "/home/enzbonolis@uimm-sn.fc/CLionProjects/dico/dico.txt"
...
int main(void)
{
    FILE *file = fopen(FILENAME, "r");    // Open the file "dico.txt" in read mode
    if (file == NULL)
    {
